...
public class GameBuilderTest {
    ...
    public void game_map() throws IOException {
        ...
        expectedInteractables.add(InteractableFactory.getInteractable("Item", 132, 26, 32, 25, "Volcano_item", 0));
    ...
    public void game_Backpack() throws IOException {
        ...
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 73, 112, 23, 20, "rock_backpack",0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 72, 72, 31, 21, "rope_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 104, 105, 20, 29, "beer1_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 104, 105, 20, 29, "beer2_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 104, 105, 20, 29,"beer3_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 44, 17, 14, 118,"broom_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 24, 18, 16, 117,"pipe_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 104, 40, 23, 14,"cloth_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 146, 16, 29, 127,"branch_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 72, 24, 18, 25,"flower_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 105, 80, 9, 11,"potion1_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 117, 80, 9, 11,"potion2_backpack", 0));
        expectedInteractables.add(InteractableFactory.getInteractable("BItem", 94, 30, 9, 18,"key_backpack", 0));
    ...
    public void game_pauseMenu() {
        ...
        assertEquals(4, game.getPauseMenu().getNumberEntries());
